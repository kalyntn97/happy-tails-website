...
export default function Page() {
  return (
    <div className="relative w-full flex flex-col items-center">
      ...
      <div className="relative flex flex-col lg:flex-row w-full xl:w-2/3 lg:justify-end items-center mb-10">
        <div className="lg:absolute w-4/5 lg:w-1/2 h-auto mb-10 lg:mr-10 left-10 z-20 -rotate-12">
          <Image src={'/images/levi.png'} width={500} height={500} className="w-full h-auto object-contain" alt="an image of a cat" />
        </div>
        <div className="flex flex-col w-full lg:w-1/2 bg-white dark:bg-stone-700 rounded-lg p-5 sm:p-20 mb-10 z-10 clip-card">
      ...
      <div className="relative flex flex-col lg:flex-row w-full xl:w-2/3 lg:justify-start items-center ">
        ...
        <div className="lg:absolute w-4/5 lg:w-5/12 h-auto mb-10 lg:mr-12 right-20 z-20">
