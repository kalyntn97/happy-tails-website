  ...
  return (
    <div className="relative w-full flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-10">About us</h1>
        <div className="flex flex-col lg:flex-row w-full xl:w-2/3 lg:justify-around items-center bg-white dark:bg-yellow-900 rounded-lg p-5 sm:p-20 mb-10 z-10">
        ...
        <div className="flex flex-col lg:flex-row w-full xl:w-2/3 lg:justify-around items-center mt-10 bg-white dark:bg-yellow-900 rounded-lg p-5 sm:p-20 mb-10 z-10">
          <div className="flex flex-col w-full lg:w-1/2">
