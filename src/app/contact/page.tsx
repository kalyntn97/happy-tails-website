  ...
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-center px-5 sm:px-20">
      ...
      <form onSubmit={handleSubmit} ref={form} className="relative flex flex-col w-full my-10 lg:w-1/3 sm:mt-10">
        ...
        <h4 className="text-2xl sm:text-4xl font-bold mb-2 text-blue-600">We'd love to hear from you</h4>
        ...
        <button type='submit' className="group overflow-hidden flex flex-row w-36 h-12 mt-10 bg-blue-300 dark:bg-blue-700 items-center justify-center self-center rounded-lg hover:bg-blue-500 hover:dark:bg-blue-500 transition ease-in-out duration-300 delay-75 hover:-translate-y-1">
