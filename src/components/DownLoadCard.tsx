...
export default function DownloadCard() {
  return (
    <motion.div variants={containerVariants} initial='hidden' animate='visible' className="w-full flex flex-col lg:flex-row items-center justify-center p-10 md:p-20">
      <motion.div variants={itemVariants} className="flex flex-col w-full lg:w-2/5 items-center justify-center">
        <h1 className="text-3xl md:text-4xl xl:text-5xl mb-5 sm:mb-10">Happy Tails - Your One-Stop Pet Care Companion</h1>
        <h2 className="text-base md:text-xl lg:text-2xl mb-5 md:mb-10">Keeping your pet&rsquo;s well-being at your fingertips. Download the the app to your phone today.</h2>
