...
function FeatureCard({ card }: Props) {
  return (
    <div key={card.heading} className='group overflow-hidden w-full h-[400px] sm:h-[500px] flex flex-col items-center justify-center sm-6 rounded-xl bg-stone-50 dark:bg-stone-600/70 shadow-lg transition ease-in-out duration-300'>
      ...
      <div className='flex flex-col bg-red-100 dark:bg-stone-950/70 rounded-xl w-full h-1/5 p-4 mt-auto group-hover:h-2/5 group-hover:bg-red-200 dark:group-hover:bg-stone-800/70 duration-300'>
