...
function FeatureCard({ card }: Props) {
  return (
    <div key={card.heading} className='group overflow-hidden w-full h-[400px] sm:h-[500px] flex flex-col items-center justify-center sm-6 rounded-xl bg-gray-50/50 transition ease-in-out duration-300'>
      ...
      <div className='flex flex-col bg-red-100 rounded-xl w-full h-1/5 p-4 mt-auto group-hover:h-2/5 group-hover:bg-red-200 duration-300'>
