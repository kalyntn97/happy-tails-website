...
function NavigationLinks({ onClick }: Props) {
  ...
  return (
    <>
      ...
      <Link href='/' className='bg-red-400 dark:bg-red-700 text-white relative group cursor-pointer overflow-hidden h-12 w-full sm:w-48 rounded-md transition ease-in-out duration-300 delay-75 hover:-translate-y-1 lg:hover:scale-110 hover:bg-red-600 hover:dark:bg-red-900 p-2 flex justify-center items-center font-extrabold'>
