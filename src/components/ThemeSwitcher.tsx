...
function ThemeSwitcher({}: Props) {
  ...
  return (
    <button onClick={toggleSwitch} className={`${isOn === true ? 'justify-end' : 'justify-start'} w-16 h-10 sm:w-20 sm:h-12 bg-white dark:bg-gray-600 rounded-full flex items-center p-1`}>
